/** Default sidebar size (before resize) */
export const DEFAULT_SIDEBAR_WIDTH = 256

/** Minimum allowed sidebar size (when resize) */
export const MIN_SIDEBAR_WIDTH = 180

/** Maximum allowed sidebar size (when resize) */
export const MAX_SIDEBAR_WIDTH = 480

/** Minimum size (of the window) to show sidebar */
export const MIN_SIDEBAR_RENDER_WIDTH = 680
